import { planes_ganaderia_banner } from "../assets"
...
export const Planes_Ganaderia = () => {
    return (
        <>
            <ImgText_Banner bannerImg={planes_ganaderia_banner} text="CUIDA DE TU" underline_text="GANADO" />
                        ...
                        <div className="container-plan">
                            ...
                            <div className="information-text">
                                ...
                                <div className="grid-2-items" style={{
                                    ...
                                    <div className="items"><span>$90.00</span></div>
                                </div>
