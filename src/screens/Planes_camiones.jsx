import { planes_pesados_banner } from "../assets"
import { ImgText_Banner } from "../components/ImgText_Banner"
import CheckIcon from '@mui/icons-material/Check';

export const Planes_Camiones = () => {
    return (
        <>
            <ImgText_Banner bannerImg={planes_pesados_banner} text="TRANSPORTA TU CARGA A" underline_text="TIEMPO" />
                        ...
                        <div className="container-plan">
                            ...
                            <div className="information-text">
                                ...
                                <div className="grid-2-items" style={{
                                    ...
                                    <div className="items"><span>$199.00</span></div>
                                </div>
                        ...
                        <div className="container-plan">
                            ...
                            <div className="information-text">
                                ...
                                <div className="grid-2-items" style={{
                                    ...
                                    <div className="items"><span>$12.99</span></div>
                                </div>
