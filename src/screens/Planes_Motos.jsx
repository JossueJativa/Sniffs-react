...
export const Planes_Motos = () => {
    return (
        <>
            <ImgText_Banner bannerImg={planes_motos_banner} text="RODADAS MAS LARGAS Y" underline_text="SEGURAS" />
                        ...
                        <div className="container-plan">
                            ...
                            <div className="information-text">
                                ...
                                <div className="grid-2-items" style={{
                                    ...
                                    <div className="items"><span>$109.00</span></div>
                                </div>
                        ...
                        <div className="container-plan">
                            ...
                            <div className="information-text">
                                ...
                                <div className="grid-2-items" style={{
                                    ...
                                    <div className="items"><span>$99.00</span></div>
